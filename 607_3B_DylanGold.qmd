...
ggplot(df_6dayAvg, aes(x = Date,y = Capital_Load_SixAvg)) + 
  ...
  labs(y = "Load (MegaWatts)", title = "Average Daily Capital Load Per Year 2022-2025")
```
We can see both these graphs have a similar trend, spiking up towards the middle of the year each year to some extent. Something to note is how we don't have a full year of 2025 data.
